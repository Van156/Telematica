...
const CasoCreate = () => {
    ...
    const getPacientesMuertos = () => {
        const response = axios.get(rutas.DB_URL + 'pacientes/muertos');
    ...
    const handleSubmit = async (event) => {
        ...
        const dir_residencia = `${data.get('dir_residencia')}, Barranquilla, Colombia.`;
        ...
        if (!muertos.includes(data.get('cedula'))) {
            axios.post(post_url, {
                ...
                <div class="col-sm-12 main-section">
                    <div class="modal-content">
                        ...
                        <form class="row g-3 " onSubmit={handleSubmit}>
                            ...
                            <div class="col-6 mt-2">
                                <label for="sexo" class="form-label align-left">Sexo:</label>
                            ...
                            <div class="col-12 mt-2">
                                <label for="dir_residencia" class="form-label align-left">Dirección de residencia:</label>
                                <input class="form-control" type="address" id="dir_residencia" name="dir_residencia" required="true" />
                            </div>
                            <div class="col-12 mt-2">
                                <label for="dir_trabajo" class="form-label align-left">Dirección de trabajo:</label>
                                <input class="form-control" type="address" id="dir_trabajo" name="dir_trabajo" required="true" />
                            </div>
                            <div class="col-6 mt-2">
                                <label for="resultado" class="form-label align-left">Resultado</label>
                                <select class="form-select" name="resultado" onChange={handleChange}>
                            ...
                            {isPositivo ? <div class="col-12 mt-2">
                                <label for="estado" class="form-label align-left">Estado del usuario:</label>
